...
with DAG(dag_id="nrda_provision", schedule_interval=None, default_args=default_args, catchup=False, max_active_runs=3, user_defined_macros={
    'json': json
}) as dag:
    ...
    run_for_provision_on_staging = SparkSubmitOperator(
        ...
        conn_id="spark_conn",
        application="/usr/local/airflow/dags/scripts/nrda/provisioning/run_for_provision_on_staging.py",
        executor_memory="30g",
        executor_cores=4,
        application_args=[
