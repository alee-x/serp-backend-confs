...
if __name__ == "__main__":
    # ["expectations", "{{ dag_run.conf['project_code'] }}", "{{ json.dumps(dag_run.conf['ledger']) }}", "{{ dag_run.run_id }}"],
    # workdir = sys.argv[1]
    # project_code = sys.argv[2]
    # run_id = sys.argv[3]

    workdir = "expectations"
    project_code = "0000"
    run_id = "testrunner"
    ...
    spark_conf = SparkConf().setAppName("Expectations2").setAll(settings)
