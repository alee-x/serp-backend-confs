...
from create_views_mssql import create_views_mssql
...
with DAG(dag_id="nrda_create_mssql_view_pipeline", schedule_interval=None, default_args=default_args, catchup=False, max_active_runs=1, user_defined_macros={
    'json': json
}, tags=['working']) as dag:

    create_views_mssql = PythonOperator(
        task_id="create_views_mssql",
        python_callable=create_views_mssql,
    ...
    create_views_mssql >> prep_result_legders >> send_message 